...
ThemeData light = ThemeData(
  fontFamily: 'Roboto',
  primaryColor: const Color(0xFF3EC3F1),
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF3EC3F1))),
  colorScheme: const ColorScheme.light(primary: Color(0xFF3EC3F1), secondary: Color(0xFF3EC3F1)).copyWith(error: const Color(0xFFE84D4F)),
